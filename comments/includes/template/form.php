...
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/bold.png";?>" title="Жирный" alt="Жирный" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[B]', '[/B]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_italic')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/italic.png";?>" title="Курсив" alt="Курсив" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[I]', '[/I]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_underline')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/underline.png";?>" title="Подчеркнутый" alt="Подчеркнутый" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[U]', '[/U]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_strike')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/strike.png";?>" "Перечеркнутый" alt="Перечеркнутый" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[STRIKE]', '[/STRIKE]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_superscript')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/superscript.png";?>" title="Степень" alt="Степень" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[SUP]', '[/SUP]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_subscript')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/subscript.png";?>" title="Индекс" alt="Индекс" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[SUB]', '[/SUB]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_code')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/code.png";?>" title="Код" alt="Код" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[CODE]', '[/CODE]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_php_code')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/php_code.png";?>" title="PHP Код" alt="PHP Код" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[PHP]', '[/PHP]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_quote')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/quote.png";?>" title="Кавычки" alt="Кавычки" class="cmtx_bb_code_image" onclick="cmtx_add_tags('[QUOTE]', '[/QUOTE]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_line')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/line.png";?>" title="Вставить линию" alt="Вставить линию" class="cmtx_bb_code_image" onclick="cmtx_add_tags('', '[LINE]')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_list_bullet')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/list_bullet.png";?>" title="Вставить маркированный список" alt="Вставить маркированный список" class="cmtx_bb_code_image" onclick="cmtx_enter_bullet()"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_list_numeric')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/list_numeric.png";?>" title="Вставить нумерованный список" alt="Вставить нумерованный список" class="cmtx_bb_code_image" onclick="cmtx_enter_numeric()"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_url')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/link.png";?>" title="Вставить ссылку" alt="Вставить ссылку" class="cmtx_bb_code_image" onclick="cmtx_enter_link()"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_email')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/email.png";?>" title="Вставить e-mail" alt="Вставить e-mail" class="cmtx_bb_code_image" onclick="cmtx_enter_email()"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_image')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/image.png";?>" title="Вставить изображение" alt="Вставить изображение" class="cmtx_bb_code_image" onclick="cmtx_enter_image()"/>
<?php } ?>
<?php if (cmtx_setting('enabled_bb_code_video')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/bb_code/video.png";?>" title="Вставить видео" alt="Вставить видео" class="cmtx_bb_code_image" onclick="cmtx_enter_video()"/>
<?php } ?>
</div>
<?php } ?>
...
<img src="<?php echo cmtx_comments_folder() . "images/smilies/smile.gif";?>" title="Улыбка" alt="Улыбка" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':smile:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_sad')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/sad.gif";?>" title="Печаль" alt="Печаль" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':sad:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_huh')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/huh.gif";?>" title="Удивление" alt="Удивление" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':huh:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_laugh')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/laugh.gif";?>" title="Смех" alt="Смех" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':laugh:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_mad')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/mad.gif";?>" title="Злость" alt="Злость" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':mad:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_tongue')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/tongue.gif";?>" title="Язык" alt="Язык" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':tongue:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_crying')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/crying.gif";?>" title="Возмущение" alt="Возмущение" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':crying:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_grin')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/grin.gif";?>" title="Ухмылка" alt="Ухмылка" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':grin:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_wink')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/wink.gif";?>" title="Подмигнуть" alt="Подмигнуть" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':wink:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_scared')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/scared.gif";?>" title="Испуг" alt="Испуг" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':scared:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_cool')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/cool.gif";?>" title="Круто" alt="Круто" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':cool:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_sleep')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/sleep.gif";?>" title="Скука" alt="Скука" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':sleep:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_blush')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/blush.gif";?>" title="Смущение" alt="Смущение" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':blush:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_unsure')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/unsure.gif";?>" title="Несерьёзно" alt="Несерьёзно" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':unsure:')"/>
<?php } ?>
<?php if (cmtx_setting('enabled_smilies_shocked')) { ?>
<img src="<?php echo cmtx_comments_folder() . "images/smilies/shocked.gif";?>" title="Шокирован" alt="Шокирован" class="cmtx_smiley_image" onclick="cmtx_add_tags('', ':shocked:')"/>
<?php } ?>
</div>
<?php } ?>
